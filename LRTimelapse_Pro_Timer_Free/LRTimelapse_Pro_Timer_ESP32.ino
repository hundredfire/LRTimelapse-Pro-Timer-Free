...
const String CAPTION  =  "Pro-Timer ESP32";
const String CAPTION1  = "TLCS  Edition   ";

LCD_Keypad_Reader keypad(36); // Use ADC1_CHANNEL_0 (GPIO 36) for keypad
// Pin assignments for LCD Keypad Shield on ESP32
// RS -> 23, EN -> 22, D4 -> 21, D5 -> 19, D6 -> 18, D7 -> 5
...
const byte Onboard_LED = 2;    // Common for ESP32 boards
const byte BACK_LIGHT  = 4;    // Must be a PWM-capable pin for dimming

// Camera 1 setings
#define Cam1_ext_HW
//#define Cam1_int_HW
const byte Cam1_shoot = 26;
const byte Cam1_focus = 25;

// Camera 2 setings / Sensor
#ifdef sensor
...
const byte off = 0;
#ifdef DPH
// DPH option is not applicable to this ESP32 pinout
const byte Cam2_shoot = 33;
const byte Cam2_focus = 32;
#else
const byte Cam2_shoot = 33;
const byte Cam2_focus = 32;
#endif //DPH
